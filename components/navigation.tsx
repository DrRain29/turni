        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center">
            <div className="flex-shrink-0">
              <span className="font-bold text-xl">Entermed Portal</span>
            </div>
              ...
              <button className="bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                ...
                >
                  <path
                    ...
                    strokeWidth="2"
                    d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 13.828V11.71l-1-1a4.5 4.5 0 00-6.405-6.405L11.71 3.71A4.5 4.5 0 0013 3h1.083c.321 0 .637.025.94.074a4.005 4.005 0 002.254.833l.5.5a4.5 4.5 0 001.78 7.763L15 17z"
                  />
                </svg>
              </button>
      ...
      {/* <div className="md:hidden">
        ...
        <div className="pt-4 pb-3 border-t border-gray-700">
          <div className="flex items-center px-5">
            <div className="flex-shrink-0">
              <img className="h-10 w-10 rounded-full" src="https://images.unsplash.com/photo-1472099173936-5203891eb81f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" />
            </div>
            <div className="ml-3">
            ...
            <button className="ml-auto bg-gray-800 flex-shrink-0 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
              ...
              <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 13.828V11.71l-1-1a4.5 4.5 0 00-6.405-6.405L11.71 3.71A4.5 4.5 0 0013 3h1.083c.321 0 .637.025.94.074a4.005 4.005 0 002.254.833l.5.5a4.5 4.5 0 001.78 7.763L15 17z" />
              </svg>
            </button>
          </div>
